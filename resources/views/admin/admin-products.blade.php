                        ...
                        <div class="white_card position-relative mb_20 ">
                            <div class="card-body">
                                ...
                                <div class="option" style="display: flex;justify-content: space-between;">
                                    <div class="d-grid">
                                        <a href="/admin/product_detail/{{$product->id}}"><button class="btn_2">Edit</button></a>
                                    </div>
                                    <div class="d-grid">
                                        <form action="/api/admin/product_delete/{{$product->id}}" method="post">
                                            <button type="submit" class="btn_2">Delete</button></a>
                                        </form>
                                    </div>
                                </div>
                            </div>
