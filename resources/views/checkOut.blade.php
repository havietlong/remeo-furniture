                        ...
                        <div class="section-padding">
                            <div class="section-container p-l-r">
                                <div class="shop-checkout">
                                    <form name="checkout" method="post" class="checkout" action="/api/checkOut" autocomplete="off">
                                        <div class="row">
                                            <div class="col-xl-8 col-lg-7 col-md-12 col-12">
                                                    ...
                                                    <div class="billing-fields">
                                                        ...
                                                        <div class="billing-fields-wrapper">
                                                            <p class="form-row form-row-first validate-required">
                                                                ...
                                                                <span class="input-wrapper"><input type="text" class="input-text" name="first_name" value=""></span>
                                                            </p>
                                                            <p class="form-row form-row-last validate-required">
                                                                <label>Last name <span class="required" title="required">*</span></label>
                                                                <span class="input-wrapper"><input type="text" class="input-text" name="last_name" value=""></span>
                                                            </p>
                                                            ...
                                                            <p class="form-row address-field validate-required form-row-wide">
                                                                ...
                                                                <span class="input-wrapper">
                                                                    <input type="text" class="input-text" name="address" placeholder="House number and street name" value="">
                                                                </span>
                                                            </p>
                                                            ...
                                                            <p class="form-row form-row-wide validate-required validate-phone">
                                                                ...
                                                                <span class="input-wrapper">
                                                                    <input type="tel" class="input-text" name="phoneNumber" value="">
                                                                </span>
                                                            </p>
                                                ...
                                                <div class="additional-fields">
                                                    <p class="form-row notes">
                                                        ...
                                                        <span class="input-wrapper">
                                                            <textarea name="note" class="input-text" placeholder="Notes about your order, e.g. special notes for delivery." rows="2" cols="5"></textarea>
                                                        </span>
                                                    </p>
                                                </div>
                                            </div>
                                                ...
                                                <div class="checkout-review-order">
                                                        ...
                                                        <div class="order-total">
                                                            ...
                                                            <div class="total-price">
                                                                <strong>
                                                                    ...
                                                                    <input name="price" value="<?= session('total') ?>" hidden/>
                                                    ...
                                                    <div id="payment" class="checkout-payment">
                                                        ...
                                                        <div class="form-row place-order">
                                                            ...
                                                            ?> 
                                                            <a href="/login" class="button alt" name="checkout_place_order" value="Place order">Place order</a>
                                                            <?php
                                                            }
                                                            ?>
                                                        </div>
